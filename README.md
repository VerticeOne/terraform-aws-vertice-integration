...
| <a name="input_cor_report_enabled"></a> [cor\_report\_enabled](#input\_cor\_report\_enabled) | Whether to enable the module that creates Cost Optimization Recommendations Report export.                                                                                                                                                                                                                                                                                                                                                           | `bool` | no |
...
| <a name="input_cur_report_enabled"></a> [cur\_report\_enabled](#input\_cur\_report\_enabled) | Whether to enable the module that creates Cost Usage Report export.                                                                                                                                                                                                                                                                                                                                                                                  | `bool` | no |
