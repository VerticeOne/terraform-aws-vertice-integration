...
| <a name="input_report_bucket_names"></a> [report\_bucket\_names](#input\_report\_bucket\_names)                                                              | The names of the buckets which will be used to store the CUR and COR data for Vertice. | `list(string)`                                                                                          | `[]`                                                       | no |
